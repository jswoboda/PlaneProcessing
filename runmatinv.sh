...
cp ~/DATA/PlaneProcessing/Phased_Array/exp_width_stat_01/FittedInv/*.h5 ~/Dropbox/Inversion/Tik/
...
cp ~/DATA/PlaneProcessing/Phased_Array/exp_width_stat_01/FittedInv/*.h5 ~/Dropbox/Inversion/Tikd/
...
cp ~/DATA/PlaneProcessing/Phased_Array/exp_width_stat_01/FittedInv/*.h5 ~/Dropbox/Inversion/TV/
