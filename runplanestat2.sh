#!/bin/bash
# For the case with stationary data that only has 15 second integration time
...
cp ~/DATA/PlaneProcessing/Phased_Array/exp_width_stat_01_red/fittederroronlyimages/*.png  ~/Dropbox/PlaneProcessing/Stationary_Reduced/fittederroronlyimages
